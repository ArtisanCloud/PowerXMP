<template>
  <view>
    <view class="search-content pr">
      <view class="search-icon dis-inline-block pa" @tap="searchIconEvent">
        <uni-icons :type="propIcon" size="12" :color="propIconColor"></uni-icons>
      </view>
      <input type="text" confirm-type="search" class="input round wh-auto dis-block" :placeholder="propPlaceholder"
             :placeholder-class="propPlaceholderClass" :value="propDefaultValue" @confirm="searchInputEvent"
...
<script>
const app = getApp();
console.log("product-search", app.globalData)
...
export default {
  ...
  props: {
    propUrl: {
      type: String,
      default: '/pages/product-search/product-search'
    },
    propFormName: {
      type: String,
      default: 'keywords'
